...
<h1 style="text-align:center;">VERIFIKASI IRS</h1>
            ...
            <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="/dashboarddosen/verifikasiirs/verify/{{$item->id}}" method="POST">
                            @csrf
                            <button type="submit" class="btn btn-success">Setujui</button>
                        </form>
                        @else
                        <form action="/dashboarddosen/verifikasiirs/unverify/{{$item->id}}" method="POST">
                            @csrf
                            <button type="submit" class="btn btn-danger">Batal</button>
                        </form>
                        @endif
                    </td>
                    <td><a href="/dashboarddosen/verifikasiirs/download/{{ $item->id }}"
